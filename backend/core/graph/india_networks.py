...
def create_india_national_network() -> RoadNetwork:
    ...
    cities = [
        ...
        (0, "Nagpur Central Logistics Hub (Zero Mile)", 21.1458, 79.0882, True, 0.0, 0, 604800),
        # Metros & Capitals
        (1, "New Delhi (National Capital Freight Center)", 28.6139, 77.2090, False, 45.0, 0, 604800),
        (2, "Mumbai (JNPT & Western Maritime Hub)", 19.0760, 72.8777, False, 50.0, 0, 604800),
        (3, "Bengaluru (Southern Tech & Logistics Hub)", 12.9716, 77.5946, False, 45.0, 0, 604800),
        (4, "Chennai (Automotive & Port Corridor)", 13.0827, 80.2707, False, 40.0, 0, 604800),
        (5, "Kolkata (Eastern Riverine & Trade Gateway)", 22.5726, 88.3639, False, 42.0, 0, 604800),
        (6, "Hyderabad (Deccan Pharma & IT Hub)", 17.3850, 78.4867, False, 38.0, 0, 604800),
        (7, "Ahmedabad (Gujarat Industrial Express Hub)", 23.0225, 72.5714, False, 35.0, 0, 604800),
        (8, "Pune (Auto & Engineering Corridor)", 18.5204, 73.8567, False, 32.0, 0, 604800),
        (9, "Jaipur (Pink City North-West Hub)", 26.9124, 75.7873, False, 25.0, 0, 604800),
        (10, "Lucknow (Awadh Regional Freight Hub)", 26.8467, 80.9462, False, 28.0, 0, 604800),
        (11, "Chandigarh (Northern Tricity Terminal)", 30.7333, 76.7794, False, 24.0, 0, 604800),
        (12, "Kochi (Cochin Deep Sea Port Hub)", 9.9312, 76.2673, False, 30.0, 0, 604800),
        (13, "Visakhapatnam (Vizag Maritime Port)", 17.6868, 83.2185, False, 32.0, 0, 604800),
        (14, "Surat (Textile & Diamond Express Hub)", 21.1702, 72.8311, False, 28.0, 0, 604800),
        (15, "Bhopal (Central MP Industrial Center)", 23.2599, 77.4126, False, 22.0, 0, 604800),
        (16, "Indore (Commercial Logistics Capital of MP)", 22.7196, 75.8577, False, 26.0, 0, 604800),
        (17, "Patna (Bihar Central Trade Hub)", 25.5941, 85.1376, False, 30.0, 0, 604800),
        (18, "Bhubaneswar (Odisha Mining & IT Hub)", 20.2961, 85.8245, False, 28.0, 0, 604800),
        (19, "Guwahati (Northeast Gateway Corridor)", 26.1445, 91.7362, False, 35.0, 0, 604800),
        (20, "Varanasi (Purvanchal Freight Center)", 25.3176, 82.9739, False, 22.0, 0, 604800),
        (21, "Agra (Expressway Interchange Hub)", 27.1767, 78.0081, False, 20.0, 0, 604800),
        (22, "Kanpur (Leather & Defense Industrial Hub)", 26.4499, 80.3319, False, 26.0, 0, 604800),
        (23, "Amritsar (Grand Trunk Frontier Hub)", 31.6340, 74.8723, False, 20.0, 0, 604800),
        (24, "Dehradun (Himalayan Foothills Terminal)", 30.3165, 78.0322, False, 18.0, 0, 604800),
        (25, "Srinagar (NH44 Northern Origin)", 34.0837, 74.7973, False, 20.0, 0, 604800),
        (26, "Panaji (Goa Coastal Maritime Port)", 15.4909, 73.8278, False, 18.0, 0, 604800),
        (27, "Coimbatore (Pump & Textile Capital)", 11.0168, 76.9558, False, 24.0, 0, 604800),
        (28, "Madurai (Southern TN Distribution Node)", 9.9252, 78.1198, False, 22.0, 0, 604800),
        (29, "Vijayawada (AP Central Riverine Terminal)", 16.5062, 80.6480, False, 25.0, 0, 604800),
        (30, "Raipur (Chhattisgarh Steel Freight Hub)", 21.2514, 81.6296, False, 26.0, 0, 604800),
