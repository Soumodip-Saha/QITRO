...
class MapView {
  ...
  initMap() {
    ...
    // Dark Matter tile layer with CARTO API Key
    L.tileLayer('https://{s}.basemaps.cartocdn.com/rastertiles/dark_all/{z}/{x}/{y}{r}.png?key=cb1_2h0d_1_0a7406526f817a7a3f138582', {
